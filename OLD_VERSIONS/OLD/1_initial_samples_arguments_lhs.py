...
import pyDOE2  # Added pyDOE2 for Latin Hypercube Sampling
...
parser.add_argument("--method", type=str, required=True, choices=["sobol", "lhs"], help="Sampling method: 'sobol' or 'lhs'")  # Added method argument
...
if args.method == "sobol":
    ...
    # Using Latin Hypercube Sampling from pyDOE2
    sampler = pyDOE2.lhs(n=dim, samples=init_samples)
    sampler = torch.tensor(sampler, dtype=dtype, device=device)
